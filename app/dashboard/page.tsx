    ...
    <>
      <DefaultLayout>
        ...
        <div className="flex overflow-x-auto overflow-y-hidden border-b border-gray-200 whitespace-nowrap">
          <button className="inline-flex items-center h-10 px-2 py-2 -mb-px text-center text-blue-600 bg-transparent border-b-2 border-blue-500 sm:px-4 -px-1 whitespace-nowrap focus:outline-none">
            <svg
            ...
            <span className="mx-1 text-sm sm:text-base">All</span>
          </button>
          ...
          <button className="inline-flex items-center h-10 px-2 py-2 -mb-px text-center text-gray-700 bg-transparent border-b-2 border-transparent sm:px-4 -px-1 whitespace-nowrap cursor-base focus:outline-none hover:border-gray-400">
            ...
            <span className="mx-1 text-sm sm:text-base">Completed</span>
          </button>
        </div>
